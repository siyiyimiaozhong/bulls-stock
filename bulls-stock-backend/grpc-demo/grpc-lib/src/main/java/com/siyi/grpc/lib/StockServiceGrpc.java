...
public final class StockServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.siyi.grpc.lib.StockServiceRequest,
      com.siyi.grpc.lib.StockServiceReply> getGetStockPriceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetStockPrice",
      requestType = com.siyi.grpc.lib.StockServiceRequest.class,
      responseType = com.siyi.grpc.lib.StockServiceReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.siyi.grpc.lib.StockServiceRequest,
      com.siyi.grpc.lib.StockServiceReply> getGetStockPriceMethod() {
    io.grpc.MethodDescriptor<com.siyi.grpc.lib.StockServiceRequest, com.siyi.grpc.lib.StockServiceReply> getGetStockPriceMethod;
      ...
      synchronized (StockServiceGrpc.class) {
        if ((getGetStockPriceMethod = StockServiceGrpc.getGetStockPriceMethod) == null) {
          StockServiceGrpc.getGetStockPriceMethod = getGetStockPriceMethod = 
              io.grpc.MethodDescriptor.<com.siyi.grpc.lib.StockServiceRequest, com.siyi.grpc.lib.StockServiceReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "StockService", "GetStockPrice"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.siyi.grpc.lib.StockServiceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.siyi.grpc.lib.StockServiceReply.getDefaultInstance()))
  ...
  public static abstract class StockServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getStockPrice(com.siyi.grpc.lib.StockServiceRequest request,
        io.grpc.stub.StreamObserver<com.siyi.grpc.lib.StockServiceReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.siyi.grpc.lib.StockServiceRequest,
                com.siyi.grpc.lib.StockServiceReply>(
  ...
  public static final class StockServiceBlockingStub extends io.grpc.stub.AbstractStub<StockServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.siyi.grpc.lib.StockServiceReply getStockPrice(com.siyi.grpc.lib.StockServiceRequest request) {
  ...
  public static final class StockServiceFutureStub extends io.grpc.stub.AbstractStub<StockServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.siyi.grpc.lib.StockServiceReply> getStockPrice(
        com.siyi.grpc.lib.StockServiceRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_STOCK_PRICE:
          serviceImpl.getStockPrice((com.siyi.grpc.lib.StockServiceRequest) request,
              (io.grpc.stub.StreamObserver<com.siyi.grpc.lib.StockServiceReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class StockServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.siyi.grpc.lib.StockServiceProto.getDescriptor();
    }
