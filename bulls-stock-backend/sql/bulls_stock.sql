DROP
DATABASE IF EXISTS `bulls_stock`;

CREATE
DATABASE `bulls_stock`
    CHARACTER SET 'utf8'
...
VALUES ('admin', NULL, 'ISMvKXpXpadDiUoOSoAfww==', 'read_writer', 'password_refresh_token', NULL, NULL, NULL, NULL,
        NULL, NULL),
       ('app', NULL, '0qV9wdiD/SH7mVFpnfccxw==', 'server', 'password,refresh_token', NULL, NULL, NULL, NULL, NULL,
        'true');

INSERT INTO `t_trade_user`(`id`, `user_no`, `name`, `user_pwd`, `phone`, `company_id`, `email`, `address`,
                           `last_login_ip`, `last_login_time`, `status`, `create_time`)
VALUES (1, 'admin', 'admin', 'ISMvKXpXpadDiUoOSoAfww==', '123', 1, NULL, NULL, NULL, NULL, 0, NULL);